      ...
      schemas: {
        ...
        Teacher: {
          ...
          properties: {
            ...
            professionalBio: { type: 'string', example: 'Experienced mathematics teacher with 5 years of teaching experience...' },
            keyAchievements: { 
              type: 'array', 
              items: { type: 'string' },
              example: ['Teacher of the Year 2022', 'Published 3 research papers']
            },
            certifications: { 
              type: 'array', 
              items: { type: 'string' },
        ...
        School: {
          ...
          properties: {
            ...
            userId: { type: 'string', example: '507f1f77bcf86cd799439011' },
            schoolName: { type: 'string', example: 'Example International School' },
            schoolEmail: { type: 'string', format: 'email', example: 'info@exampleinternational.edu' },
            ...
            schoolSize: { 
              type: 'string', 
              enum: ['Small (1-100 students)', 'Medium (101-500 students)', 'Large (501-1000 students)', 'Very Large (1000+ students)'],
            ...
            website: { type: 'string', format: 'uri', example: 'https://exampleinternational.edu' },
            aboutSchool: { type: 'string', example: 'Example International School is a leading educational institution...' }
          }
        },
        Error: {
          type: 'object',
